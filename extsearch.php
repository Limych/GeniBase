...
<form action="<?php print $_SERVER['PHPH_SELF']?>#report">
	...
	<p class="nb">Во всех текстовых полях можно использовать метасимволы: «_» (подчёркивание)&nbsp;— заменяет один любой символ, «%» (процент)&nbsp;— заменяет любое кол-во любых символов. При использовании метасимволов фонетический поиск и расширение поиска не действуют.</p>
