...
?>';
        ...
        $this->assertEquals('', $this->ng->walk_tokens($tokens, array(
            $this->ng,
            'ignore_token'
        ), array(
            $this->ng,
        ...
        $this->assertEquals('"yes"\'We died %d times!\'', $this->ng->walk_tokens($tokens, array(
            $this->ng,
            'unchanged_token'
        ), array(
            $this->ng,
        ...
        $this->assertEquals($code, $this->ng->walk_tokens($tokens, array(
            $this->ng,
            'unchanged_token'
        ), array(
            $this->ng,
