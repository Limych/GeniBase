...
if (! isset($gb_did_header)) :
    if (! file_exists(dirname(__FILE__) . '/wp-config.php')) {
        ...
        gb_die(sprintf(/*GB_I18N_CONFIG*/" There doesn't seem to be a <code>wp-config.php</code> file. I need this before we can get started. Need more help? <a href='http://codex.wordpress.org/Editing_wp-config.php'>We got it</a>. You can create a <code>wp-config.php</code> file through a web interface, but this doesn't work for all server setups. The safest way is to manually create the file.</p><p><a href='%s' class='button'>Create a Configuration File</a>" /*/GB_I18N_CONFIG*/, $path . 'setup-config.php'), /*GB_I18N_ERROR*/ "WordPress &rsaquo; Error" /*/GB_I18N_ERROR*/);
    }
