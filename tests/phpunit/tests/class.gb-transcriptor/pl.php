    ...
    function test_transcribes()
    {
        $data = array(
            'ru' => array(
                ...
                'Dąbkowo' => 'Домбково',
                'Derdowski' => 'Дердовский',
                'Dziąba' => 'Дзёмба', // Dziąmba - по-моему неверно
                'Dzianisz' => 'Дзяниш',
                ...
                'Pyru' => 'Пыру',
                'Roman' => 'Роман',
                'Rzeczywistość' => 'Жечивистость',
                'Rzytka' => 'Житка',
                'Solec' => 'Солец',
                'Stanisław' => 'Станислав',
                'Stępowska' => 'Стемповская',
                'Stępowski' => 'Стемповский',
                'Szczawiej' => 'Щавей',
                'Szymon' => 'Шимон',
                'Wałęsa' => 'Валенса',
                'Władysław' => 'Владислав',
                'Wojciech' => 'Войцех',
                'Zając' => 'Заёнц', // Зайонц - по-моему неверно
                'Zbigniew' => 'Збигнев',
                'Ziobro' => 'Зёбро',
                'Żołnierz wolności' => 'Жолнеж вольности',
                'Żorż' => 'Жорж',
                'Zosia' => 'Зося',
