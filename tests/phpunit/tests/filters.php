...
class Tests_Filters extends GB_UnitTestCase {
	...
	function test_has_filter_after_remove_all_filters() {
	 ...
	 function test_has_filter_doesnt_reset_gb_filter() {
	 	add_action( 'action_test_has_filter_doesnt_reset_gb_filter', '__return_null', 1 );
	 	add_action( 'action_test_has_filter_doesnt_reset_gb_filter', '__return_null', 2 );
	 	add_action( 'action_test_has_filter_doesnt_reset_gb_filter', '__return_null', 3 );
	 	add_action( 'action_test_has_filter_doesnt_reset_gb_filter', array( $this, '_action_test_has_filter_doesnt_reset_gb_filter' ), 4 );

	 	do_action( 'action_test_has_filter_doesnt_reset_gb_filter' );
	 }
	 function _action_test_has_filter_doesnt_reset_gb_filter() {
	 	has_action( 'action_test_has_filter_doesnt_reset_gb_filter', '_function_that_doesnt_exist' );

		$filters = current(_gb_hooks()->filters['action_test_has_filter_doesnt_reset_gb_filter']);
