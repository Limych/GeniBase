<?php
/**
 * Tests for error handling and the GB_Error class.
 *
 * @group general
 */
class Tests_General_Errors extends GB_UnitTestCase {

	function test_create_error() {
		$error = new GB_Error( 'foo', 'message', 'data' );

		$this->assertTrue( is_gb_error( $error ) );
