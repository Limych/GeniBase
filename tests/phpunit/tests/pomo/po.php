...
msgstr[2] "бабаяга"', $po->export_entry($entry));
	...
	function test_import_from_file() {
		...
		$this->assertEquals(array('Project-Id-Version' => 'GeniBase 2.6-bleeding', 'Plural-Forms' => 'nplurals=2; plural=n != 1;'), $po->headers);
		...
		$multiple_line_entry = new Translation_Entry(array('singular' => 'The first thing you need to do is tell Blogger to let GeniBase access your account. You will be sent back here after providing authorization.', 'translations' => array("baba\ndyadogugu")));
		...
		$comments_entry = new Translation_Entry(array('singular' => 'a', 'translator_comments' => "baba\nbrubru",
			'references' => array('gb-admin/x.php:111', 'baba:333', 'baba'), 'extracted_comments' => "translators: buuu",
			'flags' => array('fuzzy')));
