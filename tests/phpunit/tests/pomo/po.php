...
msgstr[2] "бабаяга"', $po->export_entry($entry));
    ...
    function test_export_entries()
    {
        ...
        $entry2 = new Translation_Entry(array(
            'singular' => 'dyado'
        ));
        $po = new PO();
        $po->add_entry($entry);
    ...
    function test_import_from_file()
    {
        ...
        $simple_entry = new Translation_Entry(array(
            'singular' => 'moon'
        ));
        $this->assertEquals($simple_entry, $po->entries[$simple_entry->key()]);
        
        $all_types_entry = new Translation_Entry(array(
            'singular' => 'strut',
            'plural' => 'struts',
            'context' => 'brum',
            'translations' => array(
        ...
        $multiple_line_entry = new Translation_Entry(array(
            'singular' => 'The first thing you need to do is tell Blogger to let GeniBase access your account. You will be sent back here after providing authorization.',
            'translations' => array(
                "baba\ndyadogugu"
            )
        ));
        ...
        $multiple_line_all_types_entry = new Translation_Entry(array(
            'context' => 'context',
            'singular' => 'singular',
            'plural' => 'plural',
            'translations' => array(
        ...
        $comments_entry = new Translation_Entry(array(
            'singular' => 'a',
            'translator_comments' => "baba\nbrubru",
            'references' => array(
                'gb-admin/x.php:111',
        ...
        $end_quote_entry = new Translation_Entry(array(
            'singular' => 'a"'
        ));
