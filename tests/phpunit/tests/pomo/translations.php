...
class Tests_POMO_Translations extends GB_UnitTestCase
{
    ...
    {
        $entry1 = new Translation_Entry(array(
            'singular' => 'baba',
            'translations' => array(
                'babax'
            )
    ...
    {
        $entry_incomplete = new Translation_Entry(array(
            'singular' => 'baba',
            'plural' => 'babas',
            'translations' => array(
                'babax'
        ...
        $entry_toomany = new Translation_Entry(array(
            'singular' => 'wink',
            'plural' => 'winks',
            'translations' => array(
                'winki',
        ...
        $entry_2 = new Translation_Entry(array(
            'singular' => 'dyado',
            'plural' => 'dyados',
            'translations' => array(
                'dyadox',
    ...
    function test_digit_and_merge()
    {
        ...
        $entry_digit_2 = new Translation_Entry(array(
            'singular' => 2,
            'translations' => array(
                '2'
            )
