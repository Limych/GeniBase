...
class Tests_Actions extends GB_UnitTestCase
{
    ...
    function test_remove_action()
    {
        ...
        GB_Hooks::remove_action($tag, array(
            &$a,
            'action'
        ));
        GB_Hooks::do_action($tag);
    ...
    function test_all_action()
    {
        ...
        // add an 'all' action
        GB_Hooks::add_action('all', array(
            &$a,
            'action'
        ));
        $this->assertEquals(10, GB_Hooks::has_filter('all', array(
            &$a,
            'action'
        )));
        // do some actions
        ...
        GB_Hooks::remove_action('all', array(
            &$a,
            'action'
        ));
        $this->assertFalse(GB_Hooks::has_filter('all', array(
            &$a,
            'action'
        )));
    }
    ...
    function test_action_ref_array()
    {
        ...
        GB_Hooks::do_action_ref_array($tag, array(
            &$obj
        ));
    ...
    {
        GB_Hooks::add_action('test_action_self_removal', array(
            $this,
            'action_self_removal'
        ));
    ...
    {
        GB_Hooks::remove_action('test_action_self_removal', array(
            $this,
            'action_self_removal'
        ));
    }
    ...
    function test_doing_filter_real()
    {
        ...
        GB_Hooks::add_filter('testing', array(
            $this,
            'apply_testing_filter'
        ));
        $this->assertTrue(GB_Hooks::has_action('testing'));
        $this->assertEquals(10, GB_Hooks::has_action('testing', array(
            $this,
            'apply_testing_filter'
        )));
    ...
    function apply_testing_filter()
    {
        ...
        GB_Hooks::add_filter('testing_nested', array(
            $this,
            'apply_testing_nested_filter'
        ));
        $this->assertTrue(GB_Hooks::has_action('testing_nested'));
        $this->assertEquals(10, GB_Hooks::has_action('testing_nested', array(
            $this,
            'apply_testing_nested_filter'
        )));
