...
class Tests_Filters extends GB_UnitTestCase
{
    ...
    function test_remove_filter()
    {
        ...
        GB_Hooks::remove_filter($tag, array(
            $a,
            'filter'
        ));
        $this->assertEquals($val, GB_Hooks::apply_filters($tag, $val));
    ...
    function test_all_filter()
    {
        ...
        GB_Hooks::remove_filter('all', array(
            $a,
            'filterall'
        ));
    ...
    function test_filter_ref_array()
    {
        ...
        GB_Hooks::apply_filters_ref_array($tag, array(
            &$obj
        ));
    ...
    function test_filter_ref_array_result()
    {
        ...
        $result = GB_Hooks::apply_filters_ref_array($tag, array(
            'string',
            &$obj
        ));
    ...
    function test_has_filter_doesnt_reset_gb_filter()
    {
        ...
        GB_Hooks::add_action('action_test_has_filter_doesnt_reset_gb_filter', array(
            $this,
            '_action_test_has_filter_doesnt_reset_gb_filter'
        ), 4);
    ...
    function _action_test_has_filter_doesnt_reset_gb_filter()
    {
        ...
        $this->assertEquals($the_['function'], array(
            $this,
            '_action_test_has_filter_doesnt_reset_gb_filter'
        ));
    }
