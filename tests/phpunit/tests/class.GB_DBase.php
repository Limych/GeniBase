...
class Tests_GB_DBase extends GB_UnitTestCase {
	...
	function test_set_row_update() {
		...
		$key = array('id' => 'unique_key');
		$key2 = array('id' => 'unique_key', 'key2' => 456);
		$key3 = array('field`2');
		$key4 = array('field1', 'field`2');
		$key5 = array('id');
	...
	function test_remove_comments() {
		...
		$res = "SELECT * WHERE `field1` = 'data1-- data2' AND `field2` = \"data3#data 4\" " .
				"AND `field3` = '/*'';Not a comment*/' ; SELECT";
