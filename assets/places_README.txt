Свежую версию этого описания всегда можно прочитать по адресу https://github.com/Limych/GeniBase/blob/3.0.x-dev/assets/places_README.md
По мере возникновения вопросов и сложностей у волонтёров я стараюсь обновлять описание и выкладывать там.

Любые вопросы — пишите: andrey@khrolenok.ru
Для общей координации проекта создан раздел на портале GitHub: https://github.com/Limych/GeniBase/projects/1

# Справочный ресурс по теме

Указатель волостей (гмин), станов и городов Российской империи с обозначением расстояний до ближайших станций железных дорог и пароходных пристаней. - СПб., 1914
http://elib.shpl.ru/ru/indexes/values/66463
...
* Если машина имеет свои предположения о значении какого-то поля, она добавляет в строку эту информацию сразу в верном формате, но предваряя поле знаком вопроса. Эти предположения не всегда верные и не обязательны к использованию. Зато сразу видно, на что есть смысл обратить внимание.
Полей-предположений одного типа может быть несколько.
...
6. На какую точку лучше ставить географическую привязку:
  * Общее правило для населённых пунктов: всегда ищем максимально старую часть населённого пункта;
  * Для городов — на кремль или центральную площадь;
