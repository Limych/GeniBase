...
* Название(ия) места;
* Ссылка на описание этого же места в проекте Викиданные;
...
**Обратите внимание:** Допустимо вместо ссылки на Викиданные указывать ссылку на тот же объект на Википедии — при обработке машина автоматически заменит её на ссылку на Викиданных. Но, пожалуйста, не забудьте вплотную (без пробелов!) перед адресом указать символ «#» — это метка для машины, что дальше идёт ссылка на внешний ресурс.  
Пример:  
