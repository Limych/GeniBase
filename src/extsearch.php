...
<form action="<?php print $_SERVER['PHP_SELF']?>#report" class='no-print'>
	...
	<div id="help">
	<p class="nb">Фонетический поиск по фамилиям (ВНИМАНИЕ! ВРЕМЕННО ОТКЛЮЧЁН!) учитывает близость произношения разных звуков. Изначально списки были рукописными и часто писались «со слов», потому одна и та же фамилия может в списках быть записана очень по-разному.</p>
