...
<p>
	Перекодировка производится в&nbsp;соответствии со&nbsp;стандартом
	<nobr>ГОСТ 16876&ndash;71,</nobr>
	в&nbsp;который мы&nbsp;добавили небольшие дополнения, отражающие
	привычки набора транслита многими современными пользователями.
</p>
