...
crew_list(__('Preparation of electronic version of the lists', WW1_TXTDOM), array(
		...
		'Всеволод Каллистов',	'Денис Калёнов',		'Оксана Камаева',		'Татьяна Каракозова',
		'Дарья Карпова',		'Андрей Кондратюк',		'Роман Корнев',			'Виктор Котов',
		'Андрей Кочешков',		'Елена Кравцова',		'Алексей Кудрявцев',	'Елена Лаврентьева',
		'Алексей Лысиков',		'Людмила Мальцева',		'Валентин Мацкевич',	'Юлия Мезенина',
		'Александр Молчанов',	'Наталья Мясникова',	'Ольга Назарова',		'Елена Наумова',
		'Елена Овчинникова',	'Валерий Осьмаков',		'Андрей Панфилов',		'Ольга Панькова',
