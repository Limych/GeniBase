...
class PersonServiceProvider extends GedcomxServiceProvider
{
...
//         $app->put($base.'/{id}', "person.controller:update");
//         $app->delete($base.'/{id}', "person.controller:delete");
    }
