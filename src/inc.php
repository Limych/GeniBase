...
function html_header($title, $do_index = TRUE)
{
    ...
    <head>
        ...
        <title><?php echo esc_html($title); ?>
            &nbsp;-&nbsp;<?php esc_html_ex('The First World War, 1914&ndash;1918', 'HTML-page title', WW1_TXTDOM); ?></title>
    ...
    <header>
        <div class='logo'>
            <a href="<?php print site_url(); ?>" tabindex="-2"><img src="<?php print site_url('/img/logo.jpg'); ?>"
                                                                    alt=''/></a>
        </div>
        <div class='title'>
            <h1><?php _ex('The First World War, <nobr>1914&ndash;1918</nobr>', 'Project title in header', WW1_TXTDOM); ?></h1>
            <div><a href="http://www.svrt.ru/"
                    tabindex="-1"><?php _e('The project of Union of Revival of Pedigree Traditions', WW1_TXTDOM) ?></a>
            </div>
        </div>
    </header>
    <?php
...
function html_footer()
{
    ...
    <footer>
        ...
        <p class="copyright">
            <strong><?php _e('Please note:', WW1_TXTDOM); ?></strong> <?php _e('This lists are placed in the public domain for non-commercial research only. The use of this lists for commercial purposes without the express consent of the lists owners and the project participants is prohibited.', WW1_TXTDOM); ?>
        </p>
        <?php if (GB_DEBUG): ?>
...
{
    ?>
    <section class='banner_message'>
        <section class="ad hide-on-print">
            <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
            <!-- 1914 - Основной -->
            <ins class="adsbygoogle"
                 style="display:block"
                 data-ad-client="ca-pub-7764169370455068"
                 data-ad-slot="5537165712"
...
GB_Hooks::add_filter('locale', 'my_locale');
