 ...
 * Object Cache API
 *
 * @link http://codex.wordpress.org/Function_Reference/GB_Cache
 *
 * @package WordPress
 * @subpackage Cache
 */
...
function gb_cache_init() {
	$GLOBALS['gb_object_cache'] = new GB_Object_Cache();
}
 ...
 */
function gb_cache_switch_to_blog( $blog_id ) {
	global $gb_object_cache;

	return $gb_object_cache->switch_to_blog( $blog_id );
}
 ...
 *
 * This function is deprecated. Use gb_cache_switch_to_blog() instead of this
 * function when preparing the cache for a blog switch. For clearing the cache
 * during unit tests, consider using gb_cache_init(). gb_cache_init() is not
 ...
 * in the gb-content folder which is looked at in gb-settings. If that file
