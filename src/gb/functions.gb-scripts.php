<?php
/**
 * GeniBase Scripts Procedural API
 *
 * @since	2.0.0
 *
 * @package GeniBase
 ...
 * @param string $src
 *            Path to the script from the GeniBase root directory. Example: '/js/myscript.js'.
 * @param array $deps
 ...
 *            Path to the script from the root directory of GeniBase. Example: '/js/myscript.js'.
 * @param array $deps
