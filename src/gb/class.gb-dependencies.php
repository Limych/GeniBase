...
class GB_Dependencies {
	...
	/**
	 * An array of queued _GB_Dependency handle objects.
	 *
	 * @access public
	 * @since	2.0.0
	 * @var array
	...
	/**
	 * An array of _GB_Dependency handle objects already queued.
	 *
	 * @access public
	 * @since	2.0.0
	 * @var array
	...
	public function do_items( $handles = false, $group = false ) {
		...
		foreach( $this->to_do as $key => $handle ) {
			if ( !in_array($handle, $this->done, true) && isset($this->registered[$handle]) ) {
				 ...
				 *
				 * Example: The extending class GB_Scripts is used to register 'scriptaculous' as a set of registered handles:
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		if ( isset($this->registered[$handle]) )
			return false;
		$this->registered[$handle] = new _GB_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
	 ...
	 * @since	2.0.0
	 *
	 * @param array  $queue  An array of queued _GB_Dependency handle objects.
	 * @param string $handle Name of the item. Should be unique.
