 ...
 * @param string $scheme
 *            Scheme to give the home url context. See set_url_scheme().
 * @return string url link with optional path appended.
 */
 ...
 * @param string $scheme
 *            Optional. Scheme to give the site url context. Accepts
 ...
 * @param string $scheme
 *            Optional. The scheme to use. Accepts 'http' or 'https',
 ...
 * @param string $scheme
 *            Optional. Scheme to give $url. Currently 'http', 'https', 'login', 'login_post', 'admin', or 'relative'.
...
function set_url_scheme($url, $scheme = null)
{
    ...
    if (class_exists('GB_Hooks')) {
         ...
         *            Scheme requested for the URL. One of 'http', 'https', 'login',
...
function rel_canonical()
{
    ...
    if (class_exists('GB_Hooks')) {
         ...
         *       
         * @param string $link
         *            Full URL of rel=canonical link
         */
 ...
 * @return string link URL for the given page number.
 */
